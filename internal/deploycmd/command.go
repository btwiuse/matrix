// Package deploycmd implements the deploy subcommand: pack a local dist
// directory or archive and publish it through the matrix deploy API over
// plain HTTP, printing the public site URL. It is wired both as the
// standalone cmd/deploy and as the "matrix deploy" subcommand.
package deploycmd
...
// New builds the deploy command, writing output to out.
